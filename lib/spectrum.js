...
(function (window, $, undefined) {
    ...
    markup = (function () {
        ...
        var gradientFix = "";
		var app_name=new CSInterface().hostEnvironment.appName;
		var appCurrentColor="";
		switch(app_name){	
			case "PHXS":appCurrentColor="foreground";break;
			default:appCurrentColor="fill";break;
		}
        ...
        return [
            "<div class='sp-container sp-hidden'>",
                ...
                "<div class='sp-picker-container'>",
					"<div name='colorcode' class='sp-input-container sp-cf'>",
                        "<span>Color: </span><input class='sp-input' type='text' spellcheck='false'  />",
                    "</div>",
					...
					"<div class='userForegroundContainer'>",
                        "<div class='userForegroundContainerIcon'></div>",
                        "<div class='userForegroundContainerText' onclick='getAppForegroundColor(true)'>Use current "+appCurrentColor+" color</div>",
                    "</div>",
                    "<div class='sp-button-container sp-cf'>",
                        "<button class='sp-cancel' style='color: rgb(177, 0, 0);' type='button'>cancel</button>",
                        "<button style='float: right;' type='button' class='sp-choose'></button>",
                    "</div>",
                "</div>",
            "</div>"
        ].join("");
    ...
    function spectrum(element, o) {
        ...
        function initialize() {
            ...
            if (!!initialColor) {
                ...
                // In case color was black - update the preview UI and  the format
