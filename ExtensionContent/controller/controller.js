...
app.controller('projectCtrl', ['$scope', '$location', 'Config', 'projectUtils', 
function($scope, $location, Config, projectUtils){
	...
	$scope.selectProject=function(projectName){
		//alert("Processing Project"+" "+projectName);
